...
export const projects = [
  {
    ...
    gifs: [
      {
        src: "Catastrophe1.gif",
        description: "Players can use various cat-themed weapons to navigate through the city.",
      },
      { src: "Catastrophe2.gif", description: "The game include a wave system" },
      {
        src: "Catastrophe3.gif",
        description:
          "Players can sprint and slide inthe map. At the end of every round they can buy upgrades for their weapons!",
      },
    ],
    additionalImages: [
  ...
  },
  {
    ...
    gifs: [
      {
        src: "NeoPlanetWallJump.gif",
        description: "Showcase of the wall-jumping mechanic, allowing players to scale vertical surfaces.",
      },
      {
        src: "NeoPlanetAttacks.gif",
        description: "Demonstration of melee and distance attacks available to the player.",
      },
      {
        src: "NeoPlanetSlide.gif",
        description: "The sliding mechanic in action, useful for dodging attacks and quick traversal.",
      },
    ],
    additionalImages: [

...
export default function App() {
  ...
  }, [selectedProject, closeModal, sectionRefs])
  ...
  return (
    ...
    className={`px-3 py-2 rounded-md ${activeSection === 0 ? 'bg-blue-600' : 'bg-gray-700'}`}
    >
    Home
    </button>
    </li>
    ...
    className={`px-3 py-2 rounded-md ${activeSection === 1 ? 'bg-blue-600' : 'bg-gray-700'}`}
    >
    About
    </button>
    </li>
    ...
    className={`px-3 py-2 rounded-md ${activeSection === 2 ? 'bg-blue-600' : 'bg-gray-700'}`}
    >
    Projects
    </button>
    </li>
    ...
    <section
    ref={sectionRefs[0]}
    className={`h-screen w-full flex flex-col justify-center items-center p-8 bg-gray-900 transition-opacity duration-500 ease-in-out ${activeSection === 0 ? 'opacity-100' : 'opacity-0'}`}
    >
    ...
    <section
    ref={sectionRefs[1]}
    className={`min-h-screen w-full flex flex-col justify-center items-center p-8 bg-gray-800 transition-opacity duration-500 ease-in-out ${activeSection === 1 ? 'opacity-100' : 'opacity-0'}`}
    >
    ...
    <section
    ref={sectionRefs[2]}
    className={`min-h-screen w-full p-8 bg-gray-700 transition-opacity duration-500 ease-in-out ${activeSection === 2 ? 'opacity-100' : 'opacity-0'}`}
    >
